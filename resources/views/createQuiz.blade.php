        ...
        <div class="form-sliding-container" id="sliding-container">
            ...
            <div class="form-section" id="quiz-question-section-1">
                <div class="mb-3 w-50 text-center">
                    ...
                    <input type="text" class="form-control mx-auto" id="quiz_question_1"
                ...
                <div class="d-flex justify-content-between w-50 mt-3">
                    ...
                    <button class="btn w-100 btn-no-wrap btn-primary" type="button" id="add-option">Add another
                        option</button>
                    <button class="btn w-100 btn-no-wrap btn-success" type="button" id="add-another-question">Add Another
                        Question</button>
                </div>
